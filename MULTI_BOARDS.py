...
def process_tribunal_worker(url, tracking_data):
	"""Worker function to process a tribunal with its own browser"""
...
def main():
	...
	with concurrent.futures.ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
		# Submit all tasks
		future_to_url = {executor.submit(process_tribunal_worker, url, tracking_data): url for url in full_urls}
